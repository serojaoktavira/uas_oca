						...
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title">MAKANKUY !!!!!!</div>
	...
	<div class="courses">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">MAKANKUY!</h2>
			...
			<div class="row courses_row">
				...
				<div class="col-lg-3 course_col"><br>
					<div class="course">
						<div class="course_image"><img src="{{url('app/produk', $produk->gambar)}}" style="width: 300px; height: 200px;"></div>
